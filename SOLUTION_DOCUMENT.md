...
*This document provides a comprehensive breakdown of all simulation elements for enhancement with AI-generated media (video, audio, images).*
...
3. [Company State Variables](#3-company-state-variables)
4. [Game Flow & Phases](#4-game-flow--phases)
5. [Pre-Game Research Content](#5-pre-game-research-content)
6. [Weekly Scenarios (Week 1-8)](#6-weekly-scenarios-week-1-8)
7. [Decision Framework](#7-decision-framework)
8. [Stakeholder Characters](#8-stakeholder-characters)
9. [Global Events System](#9-global-events-system)
10. [Scoring Mechanics](#10-scoring-mechanics)
11. [People Analytics Data](#11-people-analytics-data)
12. [Media Enhancement Opportunities](#12-media-enhancement-opportunities)
...
- **Design Theme**: Bloomberg Terminal-inspired dark mode interface

### Key Pages
| Page | Purpose |
|------|---------|
| Landing | Game introduction, login |
| Research | Pre-game mandatory reading |
| Dashboard | Real-time company metrics |
| Briefing | Weekly intelligence reports |
| Decisions | Strategic decision interface |
| Analytics | People/workforce insights |
| Leaderboard | Team competition rankings |

### Data Flow
```
User Login → Team Assignment (Admin) → Research Phase → Weekly Game Loop
                                                              ↓
                                    ← Leaderboard ← Scoring ← Decisions
```

---

## 3. Company State Variables
...
**Narrative Content:**
"The manufacturing industry is at a critical inflection point. Our research indicates that 67% of Fortune 500 manufacturers have initiated AI transformation programs, yet only 23% report successful enterprise-wide deployment..."
...
**Narrative Content:**
"Apex Manufacturing Inc. is a mid-sized automotive parts supplier with 2,400 employees across operations, sales, customer service, R&D, and corporate functions. Founded in 1985, the company has built a reputation for quality but faces increasing pressure from competitors embracing automation..."
...
**Narrative Content:**
"Research across 200+ manufacturing transformations reveals clear patterns distinguishing successful transitions from failures. COMMUNICATION: Companies that communicate early and often about AI plans see 35% less workforce anxiety..."
...
**Narrative Content:**
"The manufacturing AI landscape has matured significantly. Key application areas include: OPERATIONS: ML-powered inventory optimization and predictive maintenance offer the highest proven ROI..."
...
**Context Articles:**
1. AI in Manufacturing: Opportunities and Risks
2. Trade Wars Heat Up
3. Gen Z Workers Shun Management Roles
...
```typescript
{
  ...
  label: string,                 // Short name (3-5 words)
  description: string,           // 2-3 sentence explanation
  financialImpact: {
    revenue?: number,            // Revenue change ($)
    cost?: number,               // One-time or recurring cost ($)
    debt?: number,               // Debt increase/decrease ($)
    cashFlow?: number,           // Cash flow impact ($)
  },
  workforceImpact: {
    employees?: number,          // Headcount change (+/-)
    morale?: number,             // Morale points (+/-)
    unionSentiment?: number,     // Union sentiment points (+/-)
    adaptability?: number,       // Adaptability points (+/-)
  },
  leadershipImpact?: {
    managementBench?: number,    // Bench strength points (+/-)
    managerVacancies?: number,   // Vacancy change (+/-)
  },
  automationImpact?: {
    level?: number,              // Automation level points (+/-)
    roi?: number,                // ROI percentage points (+/-)
  },
  risks: string[],               // 2-4 risk descriptions
  timeframe: string,             // "Immediate", "This quarter", etc.
}
```
...
## 8. Stakeholder Characters

### Internal Stakeholders

| Role | Name/Title | Stance | Key Concerns | Quote Style |
|------|------------|--------|--------------|-------------|
| Board Chair | Corporate oversight | Strategic, impatient | Shareholder value, competitive position | Formal, demanding |
| CFO | Finance executive | Analytical, cautious | ROI, debt covenants, cash flow | Numbers-focused |
| COO | Operations executive | Pragmatic, solutions-oriented | Efficiency, implementation | Practical |
| HR Director | People executive | Employee advocate | Morale, retention, culture | Empathetic |
| Operations Manager | Front-line leader | Caught in middle | Team morale, production targets | Stressed, honest |
| Sales VP | Revenue leader | Customer-focused | Pipeline, reputation | Urgent |
| General Counsel | Legal advisor | Risk-averse | Compliance, liability | Cautious |
...
## 12. Media Enhancement Opportunities

This section outlines where AI-generated video, audio, and images could enhance the simulation experience.
...
```
Create a 2-minute business documentary-style video for Week [X] of a business simulation.

Setting: [Apex Manufacturing, a mid-sized auto parts factory]
Theme: [Week theme]
Narrative: [Week narrative excerpt]
...
Style: Professional, slight tension, realistic corporate environment
```

#### Stakeholder Message Videos (16+ videos, 30-60 sec each)
**Purpose**: Deliver stakeholder pressures with emotional impact
**Style**: Direct-to-camera or voicemail style
**Characters**:
- Board Chair delivering ultimatums
- CFO presenting financial concerns
- HR Director advocating for workers
- Union organizer making demands
- Bank representative issuing warnings
- Employees sharing fears

**Prompt Template:**
```
Create a 45-second video message from [Role] at a manufacturing company.

Character: [Name], [Title]
Emotional state: [Urgent/Concerned/Angry/Hopeful]
Message: "[Stakeholder quote from scenario]"

Setting: [Office/Factory floor/Conference room]
Style: Direct address, professional but emotional
```

### Audio Opportunities

#### Podcast-Style Briefings (8 episodes, 5-8 min each)
**Purpose**: Immersive industry news experience
**Style**: Business podcast format
**Content**: Narrated versions of briefing articles with expert commentary

#### Stakeholder Voice Messages (30+ clips, 15-30 sec each)
**Purpose**: Quick pressure delivery between decisions
**Style**: Phone voicemail or Slack audio message
**Use**: Pop up during decision-making to add urgency

#### Ambient Audio (Factory Sounds)
**Purpose**: Atmospheric enhancement
**Style**: Industrial soundscape
**Variations**:
- Busy factory floor
- Quiet anxiety (whispered conversations)
- Celebration/relief
- Crisis mode (alarms, rushing)

### Image Opportunities

#### Character Portraits (15-20 images)
**Purpose**: Visual representation of stakeholders
**Style**: Professional headshots, corporate environment
**Characters**: All stakeholders listed in Section 8

#### Scenario Illustrations (8 images)
**Purpose**: Header images for each week
**Style**: Photorealistic or stylized corporate/industrial
**Content**: Depicting the week's central tension

#### Data Visualization Enhancement
**Purpose**: Animated charts for metrics
**Style**: Bloomberg Terminal aesthetic
**Content**: Dynamic versions of company state displays

#### News Article Images
**Purpose**: Illustrate briefing articles
**Style**: Stock photo / news photography
**Content**: AI adoption, union activity, factory automation

### Interactive Enhancement Ideas

#### Decision Consequence Videos (24+ clips, 15-30 sec)
**Purpose**: Show immediate reaction to decisions
**Example**: After choosing aggressive layoffs, show workers packing boxes and local news coverage

#### Employee Testimonial Library
**Purpose**: Humanize workforce impact
**Content**: Short clips of fictional employees reacting to changes
**Use**: Surface relevant testimonials based on decisions

#### Competitive Intelligence Footage
**Purpose**: Show what competitors are doing
**Content**: Fake news clips about AutoTech, PrecisionParts, FastParts
...
cash: number                     // Available cash reserves
debt: number                     // Total outstanding debt
debtInterestRate: number         // Interest rate (e.g., 0.065 = 6.5%)
aiBudget: number                // Allocated AI/automation budget
reskillingFund: number          // Workforce transition budget
lobbyingBudget: number          // Government relations budget
```

### Workforce Variables
```
employees: number               // Total headcount
morale: number                  // 0-100, employee satisfaction
unionSentiment: number          // 0-100, likelihood of organizing
unionized: boolean              // Whether company is unionized
workforceAdaptability: number   // 0-100, ability to learn/change
reskillingProgress: number      // 0-100, training completion
```

### Automation Variables
```
automationLevel: number         // 0-100, deployment extent
automationROI: number          // Return on investment percentage
roboticsInvestment: number     // Cumulative investment in robotics
```

### Leadership Variables
```
managementBenchStrength: number // 0-100, pipeline health
genZWorkforcePercentage: number // Percentage of Gen Z workers
managerVacancies: number        // Unfilled management positions
```
...
```
GET  /api/team                    // Current user's team data
GET  /api/research/reports        // Pre-game research content
GET  /api/research/historical     // Historical company data
GET  /api/research/workforce      // Workforce demographics
GET  /api/research/progress       // Research completion status
POST /api/research/mark-viewed/:id // Mark report as read
POST /api/team/complete-research  // Complete research phase
GET  /api/briefing/:week          // Weekly briefing content
GET  /api/scenario/:week          // Weekly scenario details
GET  /api/decisions/:week         // Available decisions for week
POST /api/submit-decision         // Submit team decision
...
POST /api/advance-week            // Complete week and advance
```
...
POST /api/admin/assign-team       // Assign user to team
POST /api/admin/set-admin         // Grant admin privileges
```

---

## Appendix C: Gemini Prompt Templates

### Video Generation - Weekly Briefing
```
Create a [X]-minute corporate documentary video for a business simulation game.

SETTING:
- Company: Apex Manufacturing (automotive parts)
- Location: Midwest USA factory and corporate offices
- Time period: 2026

SCENARIO:
[Insert weekly narrative]

VISUAL REQUIREMENTS:
- Mix of factory floor and office environments
- Diverse workforce (age, gender, ethnicity)
- Professional corporate aesthetic
- Slight documentary-style handheld camera work

TONE:
- Professional with underlying tension
...
NO: Obvious logos, copyrighted content, explicit violence
```

### Audio Generation - Stakeholder Message
```
Generate a [X]-second voice message from a [role] at a manufacturing company.

CHARACTER PROFILE:
- Role: [Title]
- Age: [Range]
- Emotional state: [Urgent/Concerned/Frustrated/Hopeful]
- Speaking style: [Formal/Direct/Emotional]

MESSAGE CONTENT:
"[Stakeholder quote]"

AUDIO STYLE:
- Phone/voicemail quality
- Background: [Office ambiance/Factory noise/Quiet]
- Delivery: [Rushed/Measured/Emotional]
```

### Image Generation - Character Portrait
```
Create a professional headshot photograph for a business simulation character.
...
- Expression: [Professional/Concerned/Confident/Stressed]

SETTING:
- Background: [Corporate office/Factory/Neutral]
- Lighting: Professional corporate photography
- Attire: [Business formal/Business casual/Work uniform]

STYLE:
- Photorealistic
- Corporate headshot format
...
*Purpose: AI Media Enhancement Reference*
