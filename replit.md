...
The landing page (`/`) is an Apple-style scrolling feature showcase with full-viewport sections, AI-generated hero/feature images, IntersectionObserver fade-in animations, and a stats ribbon. It highlights: 8-week simulation timeline, 17 character profiles with trait visualization, radical transparency (visible rubric criteria), AI-powered grading, Phone-a-Friend advisors, and educator tools — all linking to live pages.
