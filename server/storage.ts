...
const enhancedDecisions: EnhancedDecision[] = [
  {
    ...
    attributes: [
      ...
      },
      {
        ...
        description: "Explain your automation strategy by addressing each of the following:\n\n1. **Evidence-Based Rationale:** What specific data from the research materials supports your automation intensity and timeline? (Reference source codes AIM, APX, or TFG)\n2. **Stakeholder Trade-offs:** Which stakeholder concern — the CFO's ROI timeline, the Operations Manager's retention fears, or the HR Director's reskilling data — did you prioritize and why?\n3. **Risk Mitigation:** What is the biggest risk of your chosen approach, and what is your contingency plan if it materializes?",
        minWords: 250,
        maxWords: 600,
        placeholder: "Address all three parts:\n\n1. Evidence: 'Based on the AIM report showing [specific data], I set automation intensity to [X]% because...'\n\n2. Stakeholder Trade-offs: 'I prioritized [stakeholder] because... This means [other stakeholder's concern] is addressed by...'\n\n3. Risk: 'The biggest risk is [specific risk]. My contingency is...'",
        richText: true,
        llmWeight: 40,
        recommendedSources: [
          { code: "AIM", title: "State of AI in Manufacturing 2025", relevance: "Industry automation benchmarks and ROI data" },
          { code: "APX", title: "Apex Manufacturing: Company Profile", relevance: "Current 12% automation rate, $125M revenue, workforce demographics" },
          { code: "TFG", title: "Case Study: TechnoForge Transformation", relevance: "Comparable company that allocated 25% to reskilling" },
        ],
      },
    ],
    requiredRationaleWords: 150,
  },
  {
    ...
    attributes: [
      ...
      },
      {
        ...
        description: "Analyze your talent development strategy by addressing each of the following:\n\n1. **The Gen Z Challenge:** How does your strategy address the 72% Gen Z management refusal rate? What specific mechanisms (dual career tracks, compensation, etc.) will attract younger workers to leadership? (Reference source code WFT or APX)\n2. **Retaining Veterans:** What is your plan for experienced workers (26% approaching retirement) during the automation transition? How do you balance reskilling investment with job security guarantees?\n3. **Budget Trade-offs:** Given limited resources, what trade-off are you making between external hiring and internal training — and what evidence supports that allocation?",
        minWords: 250,
        maxWords: 600,
        placeholder: "Address all three parts:\n\n1. Gen Z: 'To address the 72% management refusal rate (APX), I am implementing [specific mechanism] because...'\n\n2. Veterans: 'For experienced workers approaching retirement, my approach is... I set job guarantee coverage to [X]% because...'\n\n3. Trade-offs: 'I allocated [X] to external hiring vs [Y] to internal training because [evidence]...'",
        richText: true,
        llmWeight: 40,
        recommendedSources: [
          { code: "WFT", title: "Workforce Transition Best Practices", relevance: "Reskilling ROI data, job guarantee effectiveness" },
          { code: "APX", title: "Apex Manufacturing: Company Profile", relevance: "26% approaching retirement, workforce demographics" },
          { code: "CMP", title: "Competitive Analysis: Auto Parts Sector", relevance: "Competitor talent strategies and compensation benchmarks" },
        ],
      },
    ],
    requiredRationaleWords: 150,
  },
  {
    ...
    attributes: [
      ...
      },
      {
        ...
        description: "Articulate your labor relations strategy by addressing each of the following:\n\n1. **Legal Boundaries:** What can and cannot management legally do during a union organizing campaign? How does this shape your communication and information campaign strategy? (Reference the Legal Landscape article)\n2. **Cost vs. Welfare:** How do you balance the CFO's warning that unionization increases labor costs 15-20% with the legitimate concerns driving 60% of workers toward union representation? What specific actions in your strategy address root causes?\n3. **Contingency Planning:** If the union vote succeeds, how will you work with the union while protecting your automation ROI? How does your Partnership Openness setting reflect this plan?",
        minWords: 300,
        maxWords: 600,
        placeholder: "Address all three parts:\n\n1. Legal: 'According to the Legal Landscape article, management can [specific actions] but cannot [specific restrictions]. My information campaign budget of [X] is designed to...'\n\n2. Cost vs. Welfare: 'The CFO warns of 15-20% cost increases, but 60% of workers support unionization because... My wage increase of [X]% and worker council [decision] address this by...'\n\n3. Contingency: 'If the vote succeeds, my Partnership Openness of [X] means... This protects automation ROI because...'",
        richText: true,
        llmWeight: 50,
        recommendedSources: [
          { code: "APX", title: "Apex Manufacturing: Company Profile", relevance: "Current labor costs, workforce sentiment data" },
          { code: "AIM", title: "State of AI in Manufacturing 2025", relevance: "How unionization affects automation implementation" },
          { code: "WFT", title: "Workforce Transition Best Practices", relevance: "Worker council models, labor-management partnership examples" },
        ],
      },
    ],
    requiredRationaleWords: 150,
