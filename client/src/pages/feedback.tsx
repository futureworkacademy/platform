...
export default function Feedback() {
      ...
      <div className="min-h-screen bg-background">
        <header className="border-b bg-card/50 backdrop-blur-sm sticky top-0 z-50">
          <div className="container mx-auto px-4 py-4 flex items-center justify-between gap-4">
            <div className="flex items-center bg-white/90 dark:bg-slate-800/90 backdrop-blur-sm rounded-md px-3 py-2">
              <img 
                src={logo} 
  ...
  return (
    <div className="min-h-screen bg-background">
      <header className="border-b bg-card/50 backdrop-blur-sm sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between gap-4">
          <div className="flex items-center bg-slate-800/90 dark:bg-slate-900/90 backdrop-blur-sm rounded-md px-3 py-1.5">
            <img 
              src={logo} 
              alt="Future Work Academy" 
